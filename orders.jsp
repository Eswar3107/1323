...
<body >
   ...
   <!-- Add the billModal element inside the <body> tag of your JSP page -->
<div id="billModal" class="modal">
    <div class="modal-content">
        <span class="close">&times;</span>
        <!-- Add the bill details content here -->
        <h3>Bill Details</h3>
        <div id="billContent">
        <p>Bill No: <span class="bill-no"></span></p>
                <p>Order Date: <span class="order-date"></span></p>
                <p>Payment Mode: <span class="payment-mode"></span></p>
                <p>Shipping Address: <span class="shipping-address"></span></p>
                <p>Shipment Date: <span class="shipment-date"></span></p>
                <p>Quantity: <span class="quantity"></span></p>
                <p>GST: <span class="gst"></span></p>
